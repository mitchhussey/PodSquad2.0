...
class Modal extends React.Component {
  public render() {
    ...
    <a className="waves-effect waves-light btn pink darken-1 modal-trigger" href="#demo-modal">Launch Modal</a>
    ...
    <div id="demo-modal" className="modal">
      ...
      <div className="modal-content">
        ...
        <div className="modal-footer">
          ...
          <a href="#!" id="closeModal" className="modal-action modal-close waves-effect waves-red btn red lighten-1">Close</a>
